...
```bash
bash ~/.claude/skills/mt-db/dbquery.sh "SELECT count(*) FROM organization_subscription WHERE organization_id='00000000-0000-4000-a000-000000000001' AND status='ACTIVE'; SELECT resource_name FROM quota_policy_item WHERE resource_name ILIKE '%FLOW_NODE%';"
```
